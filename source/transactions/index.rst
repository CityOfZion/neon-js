...
The Transactions module is exposed as::
  ...
  let transaction1 = Neon.create.claim(...args)
  transaction1 = Neon.signTransaction(transaction1, privateKey)
  let serialized1 = Neon.serializeTransaction(transaction1)
  let txid1 = Neon.getTransactionHash(transaction1)

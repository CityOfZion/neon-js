import { create } from '../../src/transactions/index.js'
  ...
  const intents = [
    {
      ...
      value: 5,
      scriptHash: getHash(createSignatureScript('031d8e1630ce640966967bc6d95223d21f44304133003140c3b52004dc981349c9'))
    },
    {
      assetId: '602c79718b16e442de58778e148d0b1084e3b2dffd5de6b7b16cee7969282de7',
      value: 10.5,
      scriptHash: getHash(createSignatureScript('02232ce8d2e2063dce0451131851d47421bfc4fc1da4db116fca5302c0756462fa'))
    }
  ]
  it('create contractTransaction', () => {
    const tx = create.contract(publicKey, data.balance, intents)

      ...
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <a href={this.docUrl('guides/basic/transfer.html', this.props.language)}>
              Guides
            </a>
          ...
          <div>
            ...
            <a href="https://github.com/cityofzion/neon-js" target="_blank" >GitHub</a>
            <a
              className="github-button"
              href={this.props.config.repoUrl}
              data-icon="octicon-star"
              data-count-href="/cityofzion/neon-js/stargazers"
        ...
        <section className="copyright">
          Copyright &copy; {currentYear} City of Zion
        </section>
      </footer>
    )
  }

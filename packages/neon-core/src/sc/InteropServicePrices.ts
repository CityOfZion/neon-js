...
const fixedPrices = {
  ...
  [InteropServiceCode.SYSTEM_CONTRACT_CREATEMULTISIGACCOUNT]: 0,
  [InteropServiceCode.SYSTEM_CONTRACT_CREATESTANDARDACCOUNT]: 0,
  ...
  [InteropServiceCode.SYSTEM_RUNTIME_GETRANDOM]: 0,
